...
def vis_mask(img, mask, col, alpha=0.4, show_border=True, border_thick=1):
    ...
    #img[idx[0], idx[1] - 350, :] = img[idx[0], idx[1], :] * (1.0 - alpha)
    #img[idx[0], idx[1] - 350, :] = img[idx[0], idx[1], :] + alpha * col

    if show_border and False:
...
def vis_one_image(
        ...
        ext='pdf', out_when_no_box=False, show_box=False):
