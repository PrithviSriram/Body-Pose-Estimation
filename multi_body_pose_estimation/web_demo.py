...
def draw_humans(npimg, humans, imgcopy=False):
    ...
    for human in humans:
        ...
        for i in range(CocoPart.Background.value):
            ...
            cv2.circle(npimg, center, 5, (0,0,255), thickness=-1, lineType=8, shift=0)
            #cv2.putText(npimg, str(i), center, cv2.FONT_HERSHEY_SIMPLEX, 1.0, (255,0,0), 3, cv2.LINE_AA)
        ...
        cv2.line(npimg, centers[2], centers[8], (0,0,255), 3)
        cv2.line(npimg, centers[5], centers[11], (0,0,255), 3)
        cv2.line(npimg, centers[8], centers[11], (0,0,255), 3)
...
if __name__ == "__main__":
    ...
    video_capture = cv2.VideoCapture('squat.mp4') #ENTER FILE NAME HERE
